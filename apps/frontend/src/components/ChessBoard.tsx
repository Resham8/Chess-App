...
export const ChessBoard = memo(
  ({
    ...
    function handleRightClick(squareRep: string) {
    ...
    function handleDrawArrow(squareRep: string) {
      if (arrowStart) {
    ...
    function handleMouseDown(e: MouseEvent<HTMLDivElement>, squareRep: string) {
      e.preventDefault();
      if (e.button === 2) {
    ...
    function handleMouseUp(e: MouseEvent<HTMLDivElement>, squareRep: string) {
      e.preventDefault();
      if (!started) {
        return;
      }
