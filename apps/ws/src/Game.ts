...
import { AuthProvider } from "@repo/db/client";
...
type GAME_STATUS =
  ...
  | "TIME_UP"
  | "PLAYER_EXIT";
type GAME_RESULTS = "WHITE_WINS" | "BLACK_WINS" | "DRAW";
...
export class Game {
  ...
  public result: GAME_RESULTS | null = null;
  ...
  async endGame(status: GAME_STATUS, result: GAME_RESULTS) {
